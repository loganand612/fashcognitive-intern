...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'backend', os.environ.get('ALLOWED_HOST', '')]
...
MIDDLEWARE = [
    ...
    'users.csrf_exempt_middleware.CSRFExemptMiddleware',  # Custom CSRF exemption - MUST be before CsrfViewMiddleware
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'users.middleware.AccessVerificationMiddleware',  # Re-enabled with admin permission fix
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'Fash'),
        'USER': os.environ.get('DATABASE_USER', 'log'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'log'),
