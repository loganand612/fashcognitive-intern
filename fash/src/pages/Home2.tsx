...
import logo from './assets/logs.png'; // Replace with your actual logo path
import reportImage from './assets/logs.png'; // Replace with the actual middle content image path (300px x 200px)
import qrCodeImage from './assets/logs.png'; // Replace with your actual QR code image path
import './Home2.css';
