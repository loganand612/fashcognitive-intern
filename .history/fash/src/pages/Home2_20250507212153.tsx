...
const Home2: React.FC = () => {
  ...
  return (
    <div className="Home2fashcognitive-container">
      ...
      >
        <MousePointer size={16} color="white" style={{ opacity: cursorVariant !== "default" ? 1 : 0 }} />
"use client"
...
const Home2: React.FC = () => {
  ...
  // Function to enter button cursor state
  const enterButton = () => setCursorVariant("buttonHover")
  // Function to enter link cursor state
  const enterLink = () => setCursorVariant("link")
  // Function to reset cursor state
  const leaveHover = () => setCursorVariant("default")
...
<div className="Home2logo">
            <span className="Home2logo-text">FASHCOGNITIVE</span>
          </div>
...
<ul className="Home2nav-list">
              <li className="Home2nav-item">
<a href="#features" className="Home2nav-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                  Features <ChevronDown size={16} />
                </a>
                <div className="Home2dropdown-menu">
<a href="#template-builder" className="Home2dropdown-item">
                    Template Builder
                  </a>
                  <a href="#mobile-app" className="Home2dropdown-item">
                    Mobile App
                  </a>
                  <a href="#reporting" className="Home2dropdown-item">
                    Reporting
                  </a>
                  <a href="#actions" className="Home2dropdown-item">
                    Action Tracking
                  </a>
                </div>
              </li>
              <li className="Home2nav-item">
                <a href="#templates" className="Home2nav-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                  Templates
                </a>
              </li>
              <li className="Home2nav-item">
                <a href="#pricing" className="Home2nav-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                  Pricing
                </a>
              </li>
              <li className="Home2nav-item">
                <a href="#resources" className="Home2nav-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                  Resources <ChevronDown size={16} />
                </a>
                <div className="Home2dropdown-menu">
                  <a href="#blog" className="Home2dropdown-item">
                    Blog
                  </a>
                  <a href="#guides" className="Home2dropdown-item">
                    Guides
                  </a>
                  <a href="#support" className="Home2dropdown-item">
                    Support
                  </a>
                </div>
              </li>
              <li className="Home2nav-item">
                <a href="#contact" className="Home2nav-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                  Contact Us
                </a>
              </li>
            </ul>
...
<motion.div
  ...
  animate={{
    y: [null, Math.random() * 100 - 50 + Number.parseFloat(i.toString())],
    x: [null, Math.random() * 100 - 50 + Number.parseFloat(i.toString())],
  ...
  style={{
    ...
    top: `${Math.random() * 100}%`,
    backgroundColor: `hsl(${210 + Math.random() * 30}, ${70 + Math.random() * 30}%, ${70 + Math.random() * 20}%)`,
  }}
/>
          ))}
        </div>
        ...
        <div className="Home2container">
          <div className="Home2hero-flex">
            <motion.div
              className="Home2hero-content"
              initial={{ opacity: 0, y: 30 }}
              animate={heroVisible ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <h1 className="Home2hero-title">
                Build Smarter
                <br />
                Checklists<span className="Home2accent-dot">.</span>
                <br />
                Conduct Flawless
                <br />
                Inspections<span className="Home2accent-dot">.</span>
              </h1>
              <p className="Home2hero-subtitle">
              ...
              <div className="Home2hero-buttons">
                <motion.a
                  href="#start"
                  className="Home2btn Home2btn-primary Home2btn-lg"
                  whileHover={{
                    scale: 1.05,
                  ...
                  onMouseLeave={leaveHover}
                >
                  <span className="Home2btn-text">Start Building Templates Free</span>
                  <span className="Home2btn-shine"></span>
                </motion.a>
                <motion.a
                  href="#demo"
                  className="Home2btn Home2btn-outline Home2btn-lg"
                  whileHover={{
                    scale: 1.05,
            ...
            <motion.div
              className="Home2hero-image-container"
            ...
            >
              <div className="Home2hero-image-slider">
                {bgImages.map((img, index) => (
                  <motion.div
                    key={index}
                    className={`Home2hero-slide ${currentBg === index ? "Home2active" : ""}`}
                    initial={{ opacity: 0, scale: 0.9 }}
                    animate={
                      currentBg === index
                        ? {
                  ...
                  >
                    <Image
                      ...
                      width={600}
                      height={600}
                      className="Home2hero-img"
                    />
                    <div className="Home2image-highlight"></div>
                  </motion.div>
                ))}
              </div>

              {/* Image navigation dots */}
              <div className="Home2image-nav-dots">
                {bgImages.map((_, index) => (
                  <motion.button
                    key={index}
                    className={`Home2nav-dot ${currentBg === index ? "Home2active" : ""}`}
        ...
        <div className="Home2hero-wave-container">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="Home2hero-wave">
            <path
              fill="#ffffff"
              fillOpacity="1"
      ...
      <section className="Home2workflow-section" ref={workflowRef}>
        <div className="Home2container">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={workflowVisible ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8 }}
            className="Home2workflow-header"
          >
            <h2 className="Home2section-title">Your Inspection Workflow, Simplified</h2>
            <p className="Home2section-subtitle">
              Our streamlined process makes inspections efficient from creation to action
            </p>
          </motion.div>

          <div className="Home2workflow-steps-container">
            {workflowSteps.map((step, index) => (
              <motion.div
                key={index}
                className="Home2workflow-step-card"
              ...
              >
                <div className="Home2glowing-border" style={{ borderColor: step.color }}></div>

                <div className="Home2step-number-container">
                  <div className="Home2step-number" style={{ backgroundColor: step.color }}>
                    {step.number}
                  </div>
                </div>

                <div className="Home2step-icon-container" style={{ color: step.color }}>
                  {step.icon}
                </div>

                <h3 className="Home2step-title">{step.title}</h3>

                <p className="Home2step-description">{step.description}</p>

                <ul className="Home2step-highlights">
                ...
                <motion.div
                  className="Home2step-progress-indicator"
                  initial={{ width: 0 }}
        ...
        <motion.div
          className="Home2floating-element Home2element-1"
          animate={{
            y: [0, -15, 0],
            rotate: [0, 5, 0],
          }}
        ...
        <motion.div
          className="Home2floating-element Home2element-2"
          animate={{
            y: [0, 20, 0],
            rotate: [0, -8, 0],
          }}
        ...
        <motion.div
          className="Home2floating-element Home2element-3"
          animate={{
            y: [0, -25, 0],
            rotate: [0, 10, 0],
          }}
      ...
      <section className="Home2problems-section">
        <div className="Home2container">
          <h2 className="Home2section-title">Escape Inspection Frustrations</h2>

          <div className="Home2problems-grid">
            <motion.div
              className="Home2problem-card"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="Home2problem-icon">
                <Clipboard size={32} />
              </div>
              <h3 className="Home2problem-title">Static, Inflexible Paper or PDF Checklists?</h3>
              <p className="Home2problem-text">
            ...
            >
              ...
              <h3 className="Home2problem-title">Inconsistent Data During Inspections?</h3>
              <p className="Home2problem-text">
            ...
            >
              ...
              <h3 className="Home2problem-title">Hours Spent Compiling Inspection Reports?</h3>
              <p className="Home2problem-text">
      ...
      <section className="Home2features-section" id="features" ref={featuresRef}>
        <div className="Home2container">
          <h2 className="Home2section-title">Powering Your Inspections: Key Features</h2>

          <div className="Home2features-tabs">
            <div className="Home2tabs-nav">
              {tabs.map((tab, index) => (
                <motion.button
                  key={index}
                  className={`Home2tab-button ${activeTab === index ? "Home2active" : ""}`}
                  ...
                  onMouseLeave={leaveHover}
                >
                  <span className="Home2tab-icon">{tab.icon}</span>
                  <span className="Home2tab-text">{tab.title}</span>
                </motion.button>
              ))}
            </div>

            <div className="Home2tabs-content">
              <AnimatePresence mode="wait">
                <motion.div
                  key={activeTab}
                  className="Home2tab-panel"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -20 }}
                  transition={{ duration: 0.5 }}
                >
                  <div className="Home2tab-content">
                    <h3 className="Home2tab-title">{tabs[activeTab].contentTitle}</h3>
                    <p className="Home2tab-description">{tabs[activeTab].description}</p>
                    <motion.a
                      href="#learn-more"
                      className="Home2btn Home2btn-outline Home2btn-sm"
                      whileHover={{
                        scale: 1.05,
                        backgroundColor: "var(--primary-color)",
                        color: "white",
                  ...
                  >
                    <div className="Home2tab-image-wrapper">
                      <Image
                        src={tabs[activeTab].image || "/placeholder.svg"}
                        alt={tabs[activeTab].title}
                        width={600}
                        height={400}
                        className="Home2feature-img"
                      />
                      <div className="Home2tab-image-glow"></div>
                    </div>
                  </motion.div>
                </motion.div>
              </AnimatePresence>
      ...
      {/* Stats Section */}
      <section className="Home2stats-section" ref={statsRef}>
        <div className="Home2container">
          <h2 className="Home2section-title">Impact of Smarter Templates & Inspections</h2>

          <div className="Home2stats-grid">
            {stats.map((stat, index) => (
              <motion.div
                key={index}
                className="Home2stat-card"
                initial={{ opacity: 0, scale: 0.9 }}
              ...
              >
                ...
                <div className="Home2stat-label">{stat.label}</div>
                <div className="Home2stat-shine"></div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="Home2template-feature" id="template-builder" ref={templateRef}>
        <div className="Home2container">
          <div className="Home2feature-content">
            <motion.div
              className="Home2feature-text"
              initial={{ opacity: 0, x: -50 }}
              animate={templateVisible ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.8 }}
            >
              <h2 className="Home2feature-title">Build Intelligence Into Your Checklists</h2>
              <p className="Home2feature-description">
              ...
              <ul className="Home2feature-list">
                <motion.li
                  className="Home2feature-item"
                  initial={{ opacity: 0, x: -20 }}
                  animate={templateVisible ? { opacity: 1, x: 0 } : {}}
                  transition={{ duration: 0.5, delay: 0.2 }}
                  whileHover={{ x: 5 }}
                >
                  <div className="Home2check-icon-container">
                    <Check size={20} className="Home2check-icon" />
                  </div>
            ...
            >
              <div className="Home2feature-image-wrapper">
                <Image
                  src="/placeholder.svg?height=500&width=600&text=Template+Builder"
                  alt="Template Builder"
                  width={600}
                  height={500}
                  className="Home2template-img"
                />
                <div className="Home2feature-image-glow Home2blue-glow"></div>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* Mobile App Feature */}
      <section className="Home2mobile-feature" id="mobile-app" ref={mobileRef}>
        <div className="Home2container">
          <div className="Home2feature-content Home2reverse">
            <motion.div
              className="Home2feature-image"
              initial={{ opacity: 0, x: -50 }}
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <h2 className="Home2feature-title">Capture Rich, Actionable Data from the Field</h2>
              <p className="Home2feature-description">
      ...
      {/* Industries Section */}
      <section className="Home2industries-section" ref={industriesRef}>
        <div className="Home2container">
          <h2 className="Home2section-title">Inspection Templates for Every Need</h2>

          <div className="Home2industries-grid">
            {industries.map((industry, index) => (
              <motion.div
                key={index}
                className="Home2industry-card"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                ...
                onMouseLeave={leaveHover}
              >
                <div className="Home2industry-icon">{industry.icon}</div>
                <h3 className="Home2industry-title">{industry.title}</h3>
                <motion.div
                  className="Home2industry-arrow"
                  initial={{ opacity: 0 }}
                  whileHover={{
                    opacity: 1,
                    x: 5,
                ...
                <div className="Home2card-shine"></div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="Home2testimonials-section" ref={testimonialsRef}>
        <div className="Home2container">
          <h2 className="Home2section-title">Trusted for Critical Inspections Globally</h2>

          <div className="Home2logos-row">
            {[1, 2, 3, 4, 5].map((logo) => (
              <motion.div
                key={logo}
                className="Home2logo-item"
                initial={{ opacity: 0.5 }}
                whileHover={{
                  opacity: 1,
                  scale: 1.1,
              ...
              >
                <Image
                  ...
                  width={120}
                  height={60}
                  className="Home2client-logo"
                />
              </motion.div>
            ))}
          </div>

          <div className="Home2testimonials-slider">
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                className="Home2testimonial-card"
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
              ...
              >
                <div className="Home2testimonial-content">
                  <div className="Home2quote-mark">"</div>
                  <p className="Home2testimonial-quote">{testimonial.quote}</p>
                  <div className="Home2testimonial-author">
                    <div className="Home2author-avatar-container">
                      <Image
                        src={testimonial.avatar || "/placeholder.svg"}
                        alt={testimonial.name}
                        width={60}
                        height={60}
                        className="Home2author-avatar"
                      />
                      <div className="Home2avatar-glow"></div>
                    </div>
                    <div className="Home2author-info">
                      <h4 className="Home2author-name">{testimonial.name}</h4>
                      <p className="Home2author-role">
      ...
      {/* FAQ Section */}
      <section className="Home2faq-section">
        <div className="Home2container">
          <h2 className="Home2section-title">Your Questions About Templates & Inspections</h2>

          <div className="Home2faq-list">
            {faqs.map((faq, index) => (
              <motion.div
                key={index}
                className={`Home2faq-item ${activeFaq === index ? "Home2active" : ""}`}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className="Home2faq-icon-container"
                  >
                    <ChevronDown size={20} className="Home2faq-icon" />
                  </motion.div>
                </motion.button>
                <AnimatePresence>
                  {activeFaq === index && (
                    <motion.div
                      className="Home2faq-answer"
      ...
      {/* CTA Section */}
      <section className="Home2cta-section" ref={ctaRef}>
        <div className="Home2cta-particles">
          {[...Array(15)].map((_, i) => (
            <motion.div
              key={i}
              className="Home2cta-particle"
              initial={{
                x: Math.random() * window.innerWidth,
                y: Math.random() * 300,
                opacity: Math.random() * 0.5 + 0.3,
        ...
        <div className="Home2container">
          <motion.div
            className="Home2cta-content"
            initial={{ opacity: 0, y: 30 }}
            animate={ctaVisible ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.8 }}
          >
            <h2 className="Home2cta-title">Ready to Revolutionize Your Inspection Process?</h2>
            <p className="Home2cta-text">
            ...
            <div className="Home2cta-buttons">
              <motion.a
                href="#start-free"
                className="Home2btn Home2btn-cta Home2btn-lg"
                whileHover={{
                  scale: 1.05,
              ...
              <motion.a
                href="#request-demo"
                className="Home2btn Home2btn-outline-cta Home2btn-lg"
                whileHover={{
                  scale: 1.05,
      ...
      {/* Footer */}
      <footer className="Home2footer">
        <div className="Home2footer-wave">
        ...
        <div className="Home2container">
          <div className="Home2footer-top">
            <div className="Home2footer-logo">
              <span className="Home2logo-text">FASHCOGNITIVE</span>
              <p className="Home2footer-tagline">Build Smart Checklists. Conduct Flawless Inspections.</p>
            </div>

            <div className="Home2footer-columns">
              <div className="Home2footer-column">
                <h3 className="Home2footer-heading">Product</h3>
                <ul className="Home2footer-links">
              ...
              <div className="Home2footer-column">
                <h3 className="Home2footer-heading">Resources</h3>
                <ul className="Home2footer-links">
                  <motion.li whileHover={{ x: 5 }}>
                    <a href="#blog">Blog</a>
                  </motion.li>
              ...
              <div className="Home2footer-column">
                <h3 className="Home2footer-heading">Company</h3>
                <ul className="Home2footer-links">
                  <motion.li whileHover={{ x: 5 }}>
              ...
              <div className="Home2footer-column">
                <h3 className="Home2footer-heading">Connect</h3>
                <div className="Home2social-links">
                  <motion.a
                    href="#twitter"
                    className="Home2social-link"
                ...
                <div className="Home2newsletter">
                  <h4 className="Home2newsletter-title">Subscribe to our newsletter</h4>
                  <form className="Home2newsletter-form">
                    <input type="email" placeholder="Your email" className="Home2newsletter-input" />
                    <motion.button
                      type="submit"
                      className="Home2newsletter-button"
          ...
          <div className="Home2footer-bottom">
            <p className="Home2copyright">© 2025 FASHCOGNITIVE, Inc. All rights reserved.</p>
            <div className="Home2legal-links">
              <motion.a
                href="#privacy"
