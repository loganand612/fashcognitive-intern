...
class PDFExportService {
  ...
  private addGarmentDetails(): void {
    ...
    this.doc.setFont("helvetica", "bold")
    this.doc.text("Garment Details", this.margin, this.currentY)
    this.currentY += 8
  ...
  private addCartonInfo(): void {
    ...
    if (this.reportData.cartonOffered) {
      cartonData.push(["No. of Carton Offered:", this.reportData.cartonOffered])
    }

    // Add carton to inspect
    cartonData.push(["No. of Carton to Inspect:", this.reportData.cartonToInspect])

    // Add carton inspected if available
    if (this.reportData.cartonInspected) {
      cartonData.push(["No. of Carton Inspected:", this.reportData.cartonInspected])
    }
  ...
  private addDefectsSection(): void {
    ...
    this.doc.setFontSize(14)
    this.doc.setFont("helvetica", "bold")
    this.doc.text("Defects and Logs", this.margin, this.currentY)
    this.currentY += 8

    if (this.reportData.defects && this.reportData.defects.length > 0) {
      // Create header row
      const header = ["Defect Type", "Remarks", "Critical", "Major", "Minor", "Total"]
