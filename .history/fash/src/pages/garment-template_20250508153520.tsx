  ...
  private addGarmentDetails(): void {
    ...
    if (Object.keys(this.reportData.quantities).length > 0) {
      ...
      sizes.forEach((size) => {
        ...
        totalsRow.push(sizeOrderTotal.toString())
        totalsRow.push(sizeOfferedTotal.toString())

        grandTotalOrderQty += sizeOrderTotal
        grandTotalOfferedQty += sizeOfferedTotal
      })

      totalsRow.push(grandTotalOrderQty.toString())
      totalsRow.push(grandTotalOfferedQty.toString())
      ...
      try {
        ...
        this.doc.autoTable({
          ...
          willDrawCell: (data: any) => {
            ...
            // Add borders between size columns
            if (data.column.index > 0 && data.column.index % 2 === 0 && data.column.index < header.length - 2) {
