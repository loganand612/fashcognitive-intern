    ...
    <div className="train-create-training-container">
      ...
      <header className="train-header">
        <div className="train-back-button">
          <a href="/training" className="train-back-link">
            <ArrowLeft className="train-back-icon" />
            <span>Back</span>
          </a>
        </div>

        <div className="train-tabs" style={{ display: 'flex', justifyContent: 'center' }}>
          ...
          <div className={`train-tab ${activeTab === "publish" ? "active" : ""}`} onClick={() => setActiveTab("publish")}>
            <span>Publish</span>
