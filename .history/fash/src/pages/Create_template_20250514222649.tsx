...
const CreateTemplate: React.FC = () => {
  ...
  const [collapsedPreview, setCollapsedPreview] = useState<boolean>(false)
      ...
      <div className="top-navigation">
        ...
        <div className="nav-center">
          <div className="nav-tabs">
            <button
              className={`nav-tab ${activeTab === 0 ? "active" : ""} ${activeTab > 0 ? "completed" : ""}`}
            ...
            <button
              className={`nav-tab ${activeTab === 2 ? "active" : ""} ${activeTab > 2 ? "completed" : ""}`}
      ...
      <div className="builder-content">
        {activeTab === 0 && (
          <div className="template-builder-container">
            ...
            {showMobilePreview ? (
              <div className={`mobile-preview-container ${collapsedPreview ? 'collapsed' : ''}`}>
                <button
                  className="mobile-preview-toggle"
                  onClick={() => setCollapsedPreview(!collapsedPreview)}
                  title={collapsedPreview ? "Expand preview" : "Collapse preview"}
                >
                  <ChevronRight size={16} style={{ transform: collapsedPreview ? 'rotate(0deg)' : 'rotate(180deg)' }} />
                </button>
                {renderMobilePreview()}
              </div>
            ) : (
