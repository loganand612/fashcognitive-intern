...
const Home2 = () => {
  ...
  const useOnScreen = (options = {}): [React.RefObject<HTMLElement>, boolean] => {
  ...
  return (
    <div className="fashcognitive-container">
      ...
      {/* Hero Section */}
      <section className="hero-section" ref={heroRef as React.Ref<HTMLElement>}>
      ...
      <section className="features-section" id="features" ref={featuresRef as React.Ref<HTMLElement>}>
        <div className="container">
      ...
      {/* Stats Section */}
      <section className="stats-section" ref={statsRef as React.Ref<HTMLElement>}>
        <div className="container">
      ...
      <section className="template-feature" id="template-builder" ref={templateRef as React.Ref<HTMLElement>}>
        <div className="container">
      ...
      {/* Mobile App Feature */}
      <section className="mobile-feature" id="mobile-app" ref={mobileRef as React.Ref<HTMLElement>}>
        <div className="container">
      ...
      {/* Industries Section */}
      <section className="industries-section" ref={industriesRef as React.Ref<HTMLElement>}>
        <div className="container">
      ...
      <section className="testimonials-section" ref={testimonialsRef as React.Ref<HTMLElement>}>
        <div className="container">
      ...
      {/* CTA Section */}
      <section className="cta-section" ref={ctaRef as React.Ref<HTMLElement>}>
        <div className="container">
          <motion.div
