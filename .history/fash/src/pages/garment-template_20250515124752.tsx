...
import { ChevronDown, ChevronUp, Edit, Plus, Calendar, User, MapPin, X, Check, ImageIcon, Trash2, Move, Clock, ArrowLeft, ArrowRight, CheckCircle, Settings, Ruler, Box, List, Shirt, FileText, Printer, Hash, CircleDot, Equal, ListFilter, Bell, MessageSquare, AlertTriangle, Building, Flag, Upload, Download } from 'lucide-react'
    ...
    switch (questionType) {
      ...
      case "Inspection location":
        ...
        switch (condition) {
          ...
          case "does not contain": return !strAnswer.includes(strCondition);
                  ...
                  {rule.subQuestion && (
                    <div className="report-subquestion">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          // Store subquestion answer in report data
                          setReportData(prev => ({
                            ...prev,
                            subQuestionAnswers: {
