...
// Define slide type categories
type SlideTypeKey = 'TEXT' | 'IMAGE' | 'VIDEO' | 'INTERACTIVE';

// Slide type definitions
const SLIDE_TYPES: Record<SlideTypeKey, SlideTemplate[]> = {
  TEXT: [
    {
      id: "bulleted-list",
      name: "Bulleted list",
...
const CreateTraining: React.FC = () => {
  ...
  const [selectedSlideType, setSelectedSlideType] = useState<SlideTypeKey>("TEXT")
    ...
    <div className="train-create-training-container">
      ...
      <header className="train-header">
        <div className="train-back-button">
          <a href="/" className="train-back-link">
