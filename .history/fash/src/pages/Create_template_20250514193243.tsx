...
const CreateTemplate: React.FC = () => {
  ...
  const renderTriggerUI = (question: Question, activeSection: Section) => {
    ...
    if (shouldShowTrigger(question, "ask_questions")) {
      ...
      // State for storing the response value
      const [responseValue, setResponseValue] = useState<string | number | boolean | null>(null);
        ...
        <div className="mobile-trigger-container" style={{ transition: "opacity 0.2s ease", opacity: 1 }}>
            ...
            <div className="mobile-question-response">
              ...
              {responseType === "Yes/No" && (
                <div className="mobile-yes-no">
                  <button
                    className={`mobile-yes ${responseValue === "Yes" ? "selected" : ""}`}
                    onClick={() => setResponseValue("Yes")}
                  >
                    Yes
                  </button>
                  <button
                    className={`mobile-no ${responseValue === "No" ? "selected" : ""}`}
                    onClick={() => setResponseValue("No")}
                  >
                    No
                  </button>
                  <button
                    className={`mobile-na ${responseValue === "N/A" ? "selected" : ""}`}
                    onClick={() => setResponseValue("N/A")}
                  >
                    N/A
                  </button>
                </div>
              ...
              {responseType === "Number" && (
                <input
                  ...
                  placeholder="0"
                  onChange={(e) => setResponseValue(Number(e.target.value))}
                />
              )}
              {responseType === "Multiple choice" && (
                <div className="mobile-multiple-choice">
                  <button
                    className={`mobile-choice ${responseValue === "Option 1" ? "selected" : ""}`}
                    onClick={() => setResponseValue("Option 1")}
                  >
                    Option 1
                  </button>
                  <button
                    className={`mobile-choice ${responseValue === "Option 2" ? "selected" : ""}`}
                    onClick={() => setResponseValue("Option 2")}
                  >
                    Option 2
                  </button>
                  <button
                    className={`mobile-choice ${responseValue === "Option 3" ? "selected" : ""}`}
                    onClick={() => setResponseValue("Option 3")}
                  >
                    Option 3
                  </button>
                </div>
          ...
          <div className="mobile-action-buttons">
            <button
              ...
              disabled={isSubmittingResponse || !responseValue}
            >
              Submit Responses
            </button>
          </div>
