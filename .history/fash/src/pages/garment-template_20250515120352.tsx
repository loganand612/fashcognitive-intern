...
// Type for logic operators - commented out as it's not used
// type LogicOperator =
//   | "equals"
//   | "notEquals"
//   | "greaterThan"
...
const EnhancedLogicTriggerSelector: React.FC<{
  ...
  className?: string
}> = ({ selectedTrigger, onTriggerSelect, /* onConfigChange is unused */ _onConfigChange, className = "" }) => {
  const [isOpen, setIsOpen] = useState(false)
  const dropdownRef = useRef<HTMLDivElement>(null)
...
const EnhancedLogicRuleBuilder: React.FC<{
  ...
  className?: string
}> = ({ questionType, rule, options = [], onRuleChange, onRuleDelete, /* questions is unused */ _questions = [], className = "" }) => {
...
const Garment_Template: React.FC = () => {
  ...
  const renderReportQuestionResponse = (
    ...
    // activeSection parameter is unused
    _activeSection: AppSection
  ) => {
    const value =
      ...
      <div className="template-toolbar">
        ...
        <div className="template-dates">
          ...
          <div className="date-input">
            ...
            />
            {/* Error message removed as dateErrors state was commented out */}
          </div>
        </div>
