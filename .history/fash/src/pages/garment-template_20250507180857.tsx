...
// Types
type ResponseType = "Site" | "Inspection date" | "Person" | "Inspection location" | "text" | "select" | "multiselect" | "number" | "date" | "time" | "datetime" | "boolean" | "file" | "image" | "signature" | "location" | "rating" | "scale" | "matrix" | "table" | "grid" | "repeatable" | "section" | "group" | "page" | "custom";
...
// Update the type guard for garment details content
const isGarmentDetailsContent = (content: SectionContent): content is GarmentDetailsContent => {
  return 'sizes' in content && 'colors' in content && 'aqlSettings' in content;
};
