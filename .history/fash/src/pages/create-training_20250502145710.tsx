...
export default function CreateTraining() {
  ...
  const [showAddSlideIndicator, setShowAddSlideIndicator] = useState(null)
  ...
  const slideLibraryRef = useRef(null)

  // Close slide library when clicking outside
  useEffect(() => {
    function handleClickOutside(event) {
      if (slideLibraryRef.current && !slideLibraryRef.current.contains(event.target)) {
  ...
  const addNewSlide = (slideTemplate, position = null) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
    const newSlide = {
      id: Date.now(),
      ...slideTemplate,
    ...
    if (position !== null) {
      ...
      updatedLessons[currentLessonIndex].slides.splice(position, 0, newSlide)
  ...
  const deleteSlide = (slideIndex) => {
    ...
    if (updatedLessons[currentLessonIndex].slides.length <= 1) {
      return
    }

    updatedLessons[currentLessonIndex].slides.splice(slideIndex, 1)
  ...
  const updateBulletedListItem = (index, value) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
  ...
  const removeExpandableListItem = (index) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
    updatedLessons[currentLessonIndex].slides[currentSlideIndex].items.splice(index, 1)
    setLessons(updatedLessons)
  }

  const updateRevealItem = (index, field, value) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
    updatedLessons[currentLessonIndex].slides[currentSlideIndex].items[index][field] = value
    setLessons(updatedLessons)
  }
  ...
  const handleRevealItemClick = (index) => {
      ...
      if (file) {
        ...
        reader.onload = (event) => {
          ...
          if (index !== null) {
            // For array fields
            if (field === "images") {
              currentSlide.images[index] = event.target.result
            } else if (field === "media") {
              currentSlide.media[index].source = event.target.result
              currentSlide.media[index].type = "image"
  ...
  const handleVideoUpload = (field, index = null) => {
    const input = document.createElement("input")
    input.type = "file"
    input.accept = "video/*"
    input.onchange = (e) => {
  ...
  const updateHorizontalSeriesIndex = (index) => {
  ...
  const updateImageStackIndex = (index) => {
  ...
  const updateWaypointIndex = (index) => {
  ...
  const updateHorizontalSeriesItem = (index, value) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
  ...
  const removeHorizontalSeriesItem = (index) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
    updatedLessons[currentLessonIndex].slides[currentSlideIndex].items.splice(index, 1)
    setLessons(updatedLessons)
  }
  ...
  const handleVimeoUrlChange = (url) => {
    const updatedLessons = JSON.parse(JSON.stringify(lessons))
    ...
    switch (currentSlide.type) {
          ...
          <div className="train-slide-content">
            ...
            <div className="train-horizontal-series-preview">
              ...
              <div className="train-horizontal-series-navigation">
                {currentSlide.items.map((_, index) => (
                  <div
                    key={index}
        ...
        return (
          <div className="train-slide-content">
            ...
            <div className="train-image-waypoints-container">
              ...
              {currentSlide.image &&
                currentSlide.waypoints.map((waypoint, index) => (
                  <div
                    key={index}
        ...
        return (
          <div className="train-slide-content">
            ...
            <div className="train-media-collection">
              {currentSlide.media.map((item, index) => (
      ...
      case "video-collection":
        return (
          <div className="train-slide-content">
            <h2 className="train-slide-title-preview">{currentSlide.title}</h2>
            <div className="train-video-collection-preview">
              {currentSlide.videos.map((video, index) => (
                <div key={index} className="train-video-collection-item">
                  {video ? (
                    <video src={video} controls className="train-video-collection-video"></video>
                  ) : (
                    <div className="train-video-placeholder">
                      <div className="train-video-play-icon">
        ...
        return (
          <div className="train-slide-content">
            ...
            {currentSlide.youtubeVideoId ? (
              <div className="train-embed-container">
                <iframe
    ...
    switch (currentSlide.type) {
          ...
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">LIST</label>
                <button className="train-form-section-toggle">−</button>
              </div>

              <div className="train-bulleted-list-editor">
                {currentSlide.items.map((item, index) => (
                  <div key={index} className="train-bulleted-list-item">
                    ...
                    <div className="train-item-actions">
                      <button className="train-item-copy">
                        <Copy size={16} />
                      </button>
        ...
        return (
          <>
            ...
            <div className="train-form-group">
              ...
              <div className="train-form-section-content">
                ...
                {currentSlide.items.map((item, index) => (
                  <div key={index} className="train-expandable-list-item-editor">
                    ...
                    <div className="train-item-actions">
                      ...
                      <button className="train-item-delete" onClick={() => removeHorizontalSeriesItem(index)}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                ))}
                <button className="train-add-item-button" onClick={addHorizontalSeriesItem}>
                  <Plus size={16} /> Add an item
                </button>
              </div>
            </div>
        ...
        return (
          <>
            ...
            <div className="train-form-group">
              ...
              <div className="train-reveal-editor">
                {currentSlide.items.map((item, index) => (
                  <div key={index} className="train-reveal-item-editor">
                    <div className="train-item-controls">
                      <button className="train-item-move-up">
                        <ChevronUp size={16} />
                      </button>
                    ...
                    <div className="train-item-fields">
                      ...
                      <label className="train-form-label">DESCRIPTION</label>
                      <textarea
                        className="train-form-textarea"
                    ...
                    <div className="train-item-actions">
                      ...
                      <button className="train-item-delete" onClick={() => removeRevealItem(index)}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                ))}
                <button className="train-add-item-button" onClick={addRevealItem}>
                  <Plus size={16} /> Add an item
                </button>
              </div>
            </div>
      ...
      case "quote":
        return (
          <>
            <div className="train-form-group">
              <label className="train-form-label">QUOTE</label>
              <textarea
                className="train-form-textarea"
            ...
            <div className="train-form-group">
              <label className="train-form-label">AUTHOR</label>
              <input
                type="text"
                className="train-form-input"
        ...
        return (
          <>
            ...
            {currentSlide.type === "scrolling-mix" && (
              <div className="train-form-group">
                <label className="train-form-label">MEDIA</label>
                <div className="train-media-upload">
                  <div className="train-media-preview">
                    {currentSlide.media ? (
                      currentSlide.mediaType === "image" ? (
                        <img
                          src={currentSlide.media || "/placeholder.svg"}
                          alt="Media preview"
                          className="train-media-preview-img"
                        />
                      ) : (
                        <video src={currentSlide.media} className="train-media-preview-video" controls></video>
                      )
                    ) : (
                      <div className="train-media-placeholder">
                        <Upload size={24} />
                  ...
                  <div className="train-media-buttons">
                    <button
                      className="train-media-upload-button"
                      onClick={() => {
      ...
      case "image-slide":
        return (
          <>
            ...
            <div className="train-form-group">
              <label className="train-form-label">IMAGE</label>
              <div className="train-media-upload">
                <div className="train-media-preview">
                  {currentSlide.image ? (
                    <img
                ...
                <button className="train-media-upload-button" onClick={() => handleImageUpload("image")}>
                  <ImageIcon size={16} />
                  <span>Upload Image</span>
                </button>
              </div>
      ...
      case "single-video":
        return (
          <>
            ...
            <div className="train-form-group">
              <label className="train-form-label">VIDEO</label>
              <div className="train-media-upload">
                <div className="train-media-preview">
                  {currentSlide.video ? (
                    <video src={currentSlide.video} controls className="train-media-preview-video"></video>
                  ) : (
                    <div className="train-media-placeholder">
                      <Upload size={24} />
                      <span>Upload video</span>
                ...
                <button className="train-media-upload-button" onClick={() => handleVideoUpload("video")}>
                  <Video size={16} />
                  <span>Upload Video</span>
                </button>
              </div>
      ...
      case "image-comparison":
        return (
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">BEFORE IMAGE</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-media-upload">
                ...
                <button className="train-media-upload-button" onClick={() => handleImageUpload("beforeImage")}>
                  <ImageIcon size={16} />
                  <span>Upload Image</span>
                </button>
              </div>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">AFTER IMAGE</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-media-upload">
                ...
                <button className="train-media-upload-button" onClick={() => handleImageUpload("afterImage")}>
                  <ImageIcon size={16} />
                  <span>Upload Image</span>
                </button>
              </div>
      ...
      case "scratch-to-reveal":
        return (
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">TOP IMAGE (TO SCRATCH)</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-media-upload">
                ...
                <button className="train-media-upload-button" onClick={() => handleImageUpload("topImage")}>
                  <ImageIcon size={16} />
                  <span>Upload Image</span>
                </button>
              </div>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">BOTTOM IMAGE (TO REVEAL)</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-media-upload">
                ...
                <button className="train-media-upload-button" onClick={() => handleImageUpload("bottomImage")}>
                  <ImageIcon size={16} />
                  <span>Upload Image</span>
                </button>
              </div>
      ...
      case "image-horizontal-series":
        return (
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">IMAGES</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-expandable-list-editor">
                {currentSlide.images.map((image, index) => (
                  <div key={index} className="train-expandable-list-item-editor">
                    ...
                    <div className="train-item-fields">
                      <label className="train-form-label">IMAGE {index + 1}</label>
                      <div className="train-media-upload">
                        <div className="train-media-preview">
                          {image ? (
                            <img
                ...
                <button
                  className="train-add-item-button"
                  onClick={() => {
                    const updatedLessons = JSON.parse(JSON.stringify(lessons))
      ...
      case "image-map":
        return (
          <>
            ...
            <div className="train-form-group">
              <label className="train-form-label">BACKGROUND IMAGE</label>
              <div className="train-media-upload">
                <div className="train-media-preview">
                  {currentSlide.image ? (
                    <img
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">HOTSPOTS</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-expandable-list-editor">
                {currentSlide.hotspots.map((hotspot, index) => (
                  <div key={index} className="train-expandable-list-item-editor">
                    ...
                    <div className="train-item-fields">
                      ...
                      <div className="train-form-row">
                        <div className="train-form-column">
                          <label className="train-form-label">X POSITION (%)</label>
                          <input
                            type="number"
                            min="0"
                            max="100"
                        ...
                        <div className="train-form-column">
                          <label className="train-form-label">Y POSITION (%)</label>
                          <input
                            type="number"
                            min="0"
                            max="100"
                    ...
                    <div className="train-item-actions">
                      <button className="train-item-delete" onClick={() => removeHotspot(index)}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                ))}
                <button className="train-add-item-button" onClick={addHotspot}>
      ...
      case "image-waypoints":
        return (
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">WAYPOINTS</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-expandable-list-editor">
                {currentSlide.waypoints.map((waypoint, index) => (
                  <div key={index} className="train-expandable-list-item-editor">
                    ...
                    <div className="train-item-actions">
                      <button className="train-item-delete" onClick={() => removeWaypoint(index)}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                ))}
                <button className="train-add-item-button" onClick={addWaypoint}>
      ...
      case "media-collection":
        return (
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">MEDIA ITEMS</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-expandable-list-editor">
                {currentSlide.media.map((item, index) => (
                  <div key={index} className="train-expandable-list-item-editor">
                    ...
                    <div className="train-item-fields">
                      <div className="train-form-row">
                        <label className="train-form-label">TYPE</label>
                        <select
                          className="train-form-select"
                          value={item.type}
                          onChange={(e) => {
                            const updatedLessons = JSON.parse(JSON.stringify(lessons))
                        ...
                        <div className="train-media-preview">
                          {item.source ? (
                            item.type === "image" ? (
                              ...
                              <video src={item.source} controls className="train-media-preview-video"></video>
                            )
                          ) : (
                            <div className="train-media-placeholder">
                              <Upload size={24} />
                    ...
                    <div className="train-item-actions">
                      <button className="train-item-delete" onClick={() => removeMediaItem(index)}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                ...
                {currentSlide.media.length < 3 && (
                  <button className="train-add-item-button" onClick={addMediaItem}>
      ...
      case "video-collection":
        return (
          <>
            ...
            <div className="train-form-group">
              <div className="train-form-section-header">
                <label className="train-form-label">VIDEOS</label>
                <button className="train-form-section-toggle">−</button>
              </div>
              ...
              <div className="train-expandable-list-editor">
                {currentSlide.videos.map((video, index) => (
                  <div key={index} className="train-expandable-list-item-editor">
                    <div className="train-item-fields">
                      <label className="train-form-label">VIDEO {index + 1}</label>
                      <div className="train-media-upload">
                        <div className="train-media-preview">
                          {video ? (
                            <video src={video} controls className="train-media-preview-video" />
                          ) : (
                            <div className="train-media-placeholder">
                              <Upload size={24} />
                              <span>Upload video</span>
      ...
      case "youtube":
        return (
          <>
            ...
            <div className="train-form-group">
              <label className="train-form-label">YOUTUBE URL</label>
              <input
                type="text"
                className="train-form-input"
      ...
      case "vimeo":
        return (
          <>
            ...
            <div className="train-form-group">
              <label className="train-form-label">VIMEO URL</label>
              <input
                type="text"
                className="train-form-input"
  ...
  return (
    <div className="train-create-training-container">
      {/* Top Navigation Bar */}
      <header className="train-header">
        <div className="train-back-button">
          <Link href="#" className="train-back-link">
            <ArrowLeft className="train-back-icon" />
            <span>Back</span>
          </Link>
        </div>

        <div className="train-tabs">
          <div className={`train-tab ${activeTab === "edit" ? "active" : ""}`} onClick={() => setActiveTab("edit")}>
            <span>Edit</span>
            {activeTab === "edit" && <Circle className="train-tab-indicator" />}
          </div>
          <div className={`train-tab ${activeTab === "setup" ? "active" : ""}`} onClick={() => setActiveTab("setup")}>
            <span>Set up</span>
            {activeTab === "setup" && <Circle className="train-tab-indicator" />}
          </div>
          <div
            className={`train-tab ${activeTab === "publish" ? "active" : ""}`}
            onClick={() => setActiveTab("publish")}
          >
            <span>Publish</span>
            {activeTab === "publish" && <Circle className="train-tab-indicator" />}
          </div>
        </div>

        <div className="train-action-buttons">
          <button className="train-share-button">Share</button>
          <button className="train-next-button">
            Next: Set up
            <ChevronRight className="train-next-icon" />
          </button>
        </div>
      </header>
      ...
      <div className="train-main-content">
        {/* Left Sidebar */}
        <div className="train-left-sidebar">
          <div className="train-course-info">
            <div className="train-course-thumbnail"></div>
            <div className="train-course-details">
              {isEditingCourseTitle ? (
                <input
                  ...
                  autoFocus
                  className="train-course-title-input"
                />
              ) : (
                <h2 className="train-course-title" onClick={() => setIsEditingCourseTitle(true)}>
                  {courseTitle}
                </h2>
              )}
              <div className="train-course-meta">
                <span className="train-course-status">Draft</span>
                <span className="train-lesson-count">
                  {lessons.length} lesson{lessons.length !== 1 ? "s" : ""}
                </span>
              </div>
            </div>
            <button className="train-edit-button" onClick={() => setIsEditingCourseTitle(true)}>
              <Edit className="train-edit-icon" />
            </button>
          </div>

          <div className="train-lessons-header">
            <h3>Lessons</h3>
            <button className="train-add-lesson-button" onClick={addNewLesson}>
              <Plus className="train-add-icon" />
            </button>
          </div>

          <div className="train-lessons-list">
            {lessons.map((lesson, lessonIndex) => (
              <div
                key={lesson.id}
                className={`train-lesson-item ${lessonIndex === currentLessonIndex ? "active" : ""}`}
                onClick={() => selectLesson(lessonIndex)}
              >
                <div className="train-lesson-header">
                  <div className="train-lesson-icon">
                ...
                <div className="train-lesson-duration">{lesson.duration}</div>

                <div className="train-slides-list">
                  {lesson.slides.map((slide, slideIndex) => (
                    <div
                      key={slide.id}
                      className={`train-slide-item ${lessonIndex === currentLessonIndex && slideIndex === currentSlideIndex ? "active" : ""}`}
                      onClick={(e) => {
                        e.stopPropagation()
                    ...
                    >
                      <span className="train-slide-number">{slideIndex + 1}</span>
                      {slideIndex === lesson.slides.length - 1 && lessonIndex === lessons.length - 1 && (
                        <Lock className="train-lock-icon" />
                      )}
                      <span className="train-slide-title">{slide.title}</span>

                      {hoverIndex === slideIndex && (
                        <button
                          className="train-slide-menu-button"
                          onClick={(e) => {
                            e.stopPropagation()
                  ...
                  {lessonIndex === currentLessonIndex &&
                    lesson.slides.map((_, slideIndex) => (
                      <div
                        ...
                        className="train-add-slide-indicator"
                        style={{
                      ...
                      >
                        <button
                          className="train-add-slide-between-button"
        ...
        {/* Main Content Area */}
        <div className="train-content-area">
          <div className="train-mobile-preview">
            <div className="train-mobile-frame">
              <div className="train-mobile-header">
                <div className="train-lesson-title-preview">{currentLesson.title}</div>
                <div className="train-slide-counter">
              ...
              <div className="train-navigation-controls">
                {(currentSlideIndex > 0 || currentLessonIndex > 0) && (
                  <button className="train-prev-button" onClick={handlePrevSlide}>
                    <ChevronRight className="train-prev-icon" style={{ transform: "rotate(180deg)" }} />
                  </button>
                )}
                {(currentSlideIndex < currentLesson.slides.length - 1 || currentLessonIndex < lessons.length - 1) && (
                  <button className="train-next-button-preview" onClick={handleNextSlide}>
                    <ChevronRight className="train-next-icon-preview" />
                  </button>
                )}
              </div>
          ...
          {/* Right Sidebar */}
          <div className="train-right-sidebar">
            <div className="train-sidebar-header">
              <div className="train-standard-badge">STANDARD</div>
              <div className="train-content-type">
            ...
            <div className="train-form-group">
              <button
                className="train-delete-slide-button-sidebar"
                onClick={() => {
                  setSlideToDelete(currentSlideIndex)
                  setShowDeleteConfirm(true)
                }}
      ...
      {showDeleteConfirm && (
        <div className="train-delete-confirm-overlay">
          <div className="train-delete-confirm-modal">
            <h3>Delete Slide</h3>
            <p>Are you sure you want to delete this slide? This action cannot be undone.</p>
            <div className="train-delete-confirm-buttons">
              <button
                className="train-delete-cancel-button"
                onClick={() => {
                  setShowDeleteConfirm(false)
                  setSlideToDelete(null)
                }}
              ...
              <button className="train-delete-confirm-button" onClick={() => deleteSlide(slideToDelete)}>
                Delete
              </button>
            </div>
          </div>
      ...
      {/* Slide Library Modal */}
      {showSlideLibrary && (
        <div className="train-slide-library-overlay">
          <div className="train-slide-library-modal" ref={slideLibraryRef}>
            <div className="train-slide-library-header">
              <h2>Slide library</h2>
              <div className="train-slide-library-search">
                <Search className="train-search-icon" />
                <input
                  type="text"
                  placeholder="Search"
                  value={searchQuery}
              ...
              <button className="train-close-button" onClick={() => setShowSlideLibrary(false)}>
                <X className="train-close-icon" />
              </button>
            </div>

            <div className="train-slide-library-content">
              <div className="train-slide-library-sidebar">
                <h3 className="train-slide-library-category-header">TEACH</h3>
                <div
                  className={`train-slide-library-category ${selectedSlideType === "TEXT" ? "active" : ""}`}
                  onClick={() => setSelectedSlideType("TEXT")}
                >
                  <div className="train-category-icon train-text-icon"></div>
                  <span>Text</span>
                </div>
                <div
                  className={`train-slide-library-category ${selectedSlideType === "IMAGE" ? "active" : ""}`}
                  onClick={() => setSelectedSlideType("IMAGE")}
                >
                  <div className="train-category-icon train-image-icon"></div>
                  <span>Image</span>
                </div>
                <div
                  className={`train-slide-library-category ${selectedSlideType === "VIDEO" ? "active" : ""}`}
                  onClick={() => setSelectedSlideType("VIDEO")}
                >
                  <div className="train-category-icon train-video-icon"></div>
                  <span>Video</span>
                </div>
              </div>

              <div className="train-slide-library-templates">
                <div className="train-slide-templates-grid">
                  {SLIDE_TYPES[selectedSlideType]
                    ...
                    .map((template) => (
                      <div
                        key={template.id}
                        className="train-slide-template"
                        onClick={() =>
                          addNewSlide(
                            template.template,
                      ...
                      >
                        <div className="train-slide-template-preview">
                          {template.id === "bulleted-list" && (
                            <div className="train-template-preview-content train-bulleted-list-preview">
                              <ul>
                          ...
                          {template.id === "comparison" && (
                            <div className="train-template-preview-content train-comparison-preview">
                              <div className="train-preview-title">Product X</div>
                              <div className="train-preview-box"></div>
                            </div>
                          )}
                          {template.id === "expandable-list" && (
                            <div className="train-template-preview-content train-expandable-list-preview">
                              <div className="train-preview-title">Learn more about our product range</div>
                              <div className="train-preview-expandable-item">Product X</div>
                              <div className="train-preview-expandable-item">Product Y</div>
                              <div className="train-preview-expandable-item">Product Z</div>
                            </div>
                          )}
                          {template.id === "horizontal-series" && (
                            <div className="train-template-preview-content train-horizontal-series-preview">
                              <div className="train-preview-dots">
                                <span className="train-dot active"></span>
                                <span className="train-dot"></span>
                                <span className="train-dot"></span>
                              </div>
                            </div>
                          )}
                          {template.id === "quote" && (
                            <div className="train-template-preview-content train-quote-preview">
                              <div className="train-preview-quote">Product X has defied my expectations.</div>
                              <div className="train-preview-author">Satisfied customer</div>
                            </div>
                          )}
                          {template.id === "reveal" && (
                            <div className="train-template-preview-content train-reveal-preview">
                              <div className="train-preview-title">Learn more about our product range</div>
                              <div className="train-preview-reveal-content"></div>
                              <div className="train-preview-reveal-buttons">
                                <div className="train-preview-button">Product Y</div>
                              </div>
                            </div>
                          )}
                          {template.id === "scrolling-mix" && (
                            <div className="train-template-preview-content train-scrolling-mix-preview">
                              <div className="train-preview-title">About Product Z</div>
                              <div className="train-preview-scrolling-content"></div>
                            </div>
                          )}
                          {template.id === "scrolling-text" && (
                            <div className="train-template-preview-content train-scrolling-text-preview">
                              <div className="train-preview-title">Scrolling content</div>
                              <div className="train-preview-scrolling-lines"></div>
                            </div>
                          )}
                          {template.id === "title-slide" && (
                            <div className="train-template-preview-content train-title-slide-preview">
                              <div className="train-preview-title">A title slide</div>
                              <div className="train-preview-subtitle">An optional subtitle</div>
                            </div>
                          )}
                          {template.id === "image-slide" && (
                            <div className="train-template-preview-content train-image-slide-preview">
                              <div className="train-preview-image-placeholder"></div>
                            </div>
                          )}
                          {template.id === "video-slide" && (
                            <div className="train-template-preview-content train-video-slide-preview">
                              <div className="train-preview-video-placeholder">
                                <div className="train-play-icon"></div>
                              </div>
                            </div>
                          )}
                        </div>
                        <div className="train-slide-template-info">
                          <h4>{template.name}</h4>
