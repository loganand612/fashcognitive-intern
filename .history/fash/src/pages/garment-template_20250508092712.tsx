                  ...
                  <tbody>
                      ...
                      return confirmedGarmentContent.colors.map((color: string) => (
                        <tr key={color} data-color={color}>
                          {(() => {
                            ...
                            return confirmedGarmentContent.sizes.map((size: string, sizeIndex) => (
                              <React.Fragment key={size}>
                                <td>
                                  {sizeIndex === 0 && (
                    ...
                    <tr className="total-row">
                      {(() => {
                        ...
                        return garmentSection.content.sizes.map((size: string, sizeIndex) => (
                          <React.Fragment key={size}>
                            <td className="total-cell">
                              {sizeIndex === 0 && <span className="total-label">Total</span>}
                              {calculateColumnTotal(size, "orderQty")}
                            </td>
