...
const Report: React.FC<{ template: Template }> = ({ template }) => {
  ...
  const generatePDF = async () => {
    try {
      ...
      doc.setFontSize(12)
      doc.text(`Flagged items: ${flaggedItems}`, margin, yOffset)
      yOffset += 10

      doc.text(`Status: ${scorePercentage === 100 ? "Complete" : "In progress"}`, margin, yOffset)
      yOffset += 20

      // Add site info section
      doc.setFillColor(250, 250, 250)
      doc.rect(margin, yOffset, pageWidth - margin * 2, 60, "F")
      doc.setDrawColor(230, 230, 230)
      doc.rect(margin, yOffset, pageWidth - margin * 2, 60, "S")
      yOffset += 15

      doc.setFontSize(12)
      doc.setTextColor(100, 100, 100)
      doc.text("Site conducted", margin + 5, yOffset)
      yOffset += 10
      ...
      doc.text(String(site), margin + 5, yOffset)
      yOffset += 15

      doc.setTextColor(100, 100, 100)
      doc.text("Prepared by", margin + 5, yOffset)
      yOffset += 10
      ...
      doc.text(String(preparedBy), margin + 5, yOffset)

      yOffset = yOffset - 35

      doc.setTextColor(100, 100, 100)
      doc.text("Conducted on", pageWidth / 2 + 5, yOffset)
      yOffset += 10
      ...
      doc.text(String(conductedOn), pageWidth / 2 + 5, yOffset)
      yOffset += 15

      doc.setTextColor(100, 100, 100)
      doc.text("Location", pageWidth / 2 + 5, yOffset)
      yOffset += 10
      ...
      doc.text(String(location), pageWidth / 2 + 5, yOffset)
