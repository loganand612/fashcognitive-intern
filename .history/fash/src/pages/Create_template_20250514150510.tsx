    ...
    switch (question.responseType) {
      ...
      case "Multiple choice":
        return (
          <div className="mobile-multiple-choice">
            {(question.options || []).map((option, idx) => (
              <div key={idx} className="mobile-choice-container">
                <button
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    if (newOption) {
                      ...
                      updateQuestion(activeSection.id, question.id, { options: newOptions });
                    }
                  }}
                >
                  <Edit size={12} />
                ...
                <button
                  className="mobile-delete-option"
                  onClick={(e) => {
                    e.stopPropagation();
                    const newOptions = [...(question.options || [])];
                    newOptions.splice(idx, 1);
