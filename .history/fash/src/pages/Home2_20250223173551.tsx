            ...
            <main className="main-content">
                ...
                <section className="reports-section">
                    <div className="report-content">
                        <img src="https://via.placeholder.com/300x200" alt="Branded Report" className="report-image" />
                ...
                <section className="qr-section">
                    ...
                    <div className="qr-container">
                        <img src="https://via.placeholder.com/300x300" alt="QR Code" className="qr-code" />
