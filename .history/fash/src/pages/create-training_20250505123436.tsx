...
const CreateTraining: React.FC = () => {
  ...
  const [courseTitle, setCourseTitle] = useState(courseData.courseTitle || "Untitled course")
...
// Define state for courseData and lessons
const [courseData, setCourseData] = useState({ courseDescription: "" });
const [lessons, setLessons] = useState<Lesson[]>([]);

// Ensure useEffect has access to these variables
useEffect(() => {
