...
class PDFExportService {
  ...
  private addGarmentDetails(): void {
    ...
    if (Object.keys(this.reportData.quantities).length > 0) {
      ...
      // Define a type for header cells to avoid TypeScript errors
      type HeaderCell = {
        content: string;
        styles: {
          fillColor: number[];
      ...
      const headerRow1: HeaderCell[] = [
        { content: 'COLOR', rowSpan: 2, styles: { fillColor: [245, 245, 250], fontStyle: 'bold', valign: 'middle', halign: 'center' } }
      ]
      ...
      const body = colors.map((color) => {
        ...
        // Add totals
        row.push({
          content: totalOrderQty.toString(),
          styles: {
            fontStyle: 'bold',
        ...
        row.push({
          content: totalOfferedQty.toString(),
          styles: {
            fontStyle: 'bold',
            fillColor: [250, 250, 255],
            valign: 'middle',
