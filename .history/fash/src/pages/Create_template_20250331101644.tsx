...
const Report: React.FC<{ template: Template }> = ({ template }) => {
  ...
  const generatePDF = async () => {
    try {
      ...
      doc.rect(margin, yOffset, statBoxWidth, 40, "F")
      doc.setDrawColor(230, 230, 230)
      doc.rect(margin, yOffset, statBoxWidth, 40, "S")
      ...
      // Actions box
      doc.setFillColor(248, 249, 250)
      doc.rect(margin + statBoxWidth + 10, yOffset, statBoxWidth, 40, "F")
      doc.setDrawColor(230, 230, 230)
      doc.rect(margin + statBoxWidth + 10, yOffset, statBoxWidth, 40, "S")
      ...
      // Status box
      doc.setFillColor(248, 249, 250)
      doc.rect(margin + statBoxWidth * 2 + 20, yOffset, statBoxWidth, 40, "F")
      doc.setDrawColor(230, 230, 230)
      doc.rect(margin + statBoxWidth * 2 + 20, yOffset, statBoxWidth, 40, "S")
      ...
      // Add site info section in a grid layout
      const site =
        template.sections
      ...
      // Create a 2x2 grid for site info
      const infoBoxWidth = (pageWidth - margin * 2 - 10) / 2

      // Site conducted box
      doc.setFontSize(12)
      doc.setTextColor(100, 100, 100)
      doc.text("Site conducted", margin, yOffset + 15)

      doc.setFontSize(14)
      doc.setTextColor(0, 0, 0)
      doc.text(String(site), margin, yOffset + 30)
      ...
      doc.setFontSize(12)
      doc.setTextColor(100, 100, 100)
      doc.text("Prepared by", margin, yOffset + 15)

      doc.setFontSize(14)
      doc.setTextColor(0, 0, 0)
      doc.text(String(preparedBy), margin, yOffset + 30)

      // Location box
      doc.setFontSize(12)
      doc.setTextColor(100, 100, 100)
      doc.text("Location", margin + infoBoxWidth + 10, yOffset + 15)

      doc.setFontSize(14)
      doc.setTextColor(0, 0, 0)
      doc.text(String(location), margin + infoBoxWidth + 10, yOffset + 30)
