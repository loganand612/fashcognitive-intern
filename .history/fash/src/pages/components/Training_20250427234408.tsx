...
import { ArrowLeft, ArrowRight, BookOpen, ChevronDown, Edit, FileText, Filter, LayoutGrid, List, Lock, MoreVertical, Plus, Search, Settings, Upload, Video, X, Image as ImageIcon } from 'lucide-react'
import "./Training.css"
...
export default function Training() {
  ...
  const handleAddSlide = (templateId, afterSlideId = null) => {
    ...
    if (template.id === "bulleted-list") {
      ...
      newSlide.title = "Product X vs. Product Y"
      newSlide.leftProduct = {
        name: "Product X",
        tagline: "Brilliant. In every way."
      }
      newSlide.rightProduct = {
        name: "Product Y",
        tagline: "Almost as good."
      }
      newSlide.doneText = "Continue"
    } else if (template.id === "media-collection") {
      newSlide.title = "Media Gallery"
      newSlide.media = []
      newSlide.caption = "Select each item for more details"
      newSlide.doneText = "Continue"
    }
  ...
  // Function to handle mouse enter on slide item
  const handleSlideItemMouseEnter = (e, slideId, index) => {
