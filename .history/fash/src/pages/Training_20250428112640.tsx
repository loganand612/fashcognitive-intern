                  ...
                  {selectedLessonId === lesson.id && (
                    ...
                    >
                      {lesson.slides.map((slide, index) => (
                        ...
                        >
                            => handleSlideItemMouseEnter(e, slide.id, index)}
                        >
                    ...
                    <div className="comparison-slide">
                      ...
                      >
                        <div className="comparison-slider">
                          <div 
                            className="product left-product"
                          ...
                          ></div>
                          <div 
                            className="product right-product"
          ...
          <div className="editor-header">
            ...
            <div className="editor-type">
              {selectedSlide?.type === "title" ? "Title" : 
               ...
               selectedSlide?.type === "horizontal-series" ? "Horizontal series" :
