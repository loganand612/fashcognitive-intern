...
export default function CreateTraining() {
  ...
  const addNewSlide = (slideTemplate) => {
        ...
        return (
          <div className="slide-content">
            ...
            <div className="comparison-container">
              ...
              <div className="comparison-box">
                <div className="comparison-content">{currentSlide.after.content}</div>
              </div>
            </div>
            <button className="slide-button-preview" onClick={handleNextSlide}>
              {currentSlide.buttonText}
              ...
              <div className="slide-library-templates">
                <div className="slide-templates-grid">
                  {SLIDE_TYPES[selectedSlideType]
                    ...
                    .map((template) => (
                      <div key={template.id} className="slide-template" onClick={() => addNewSlide(template.template)}>
