...
const CreateTemplate: React.FC = () => {
  ...
  const changeQuestionResponseType = (sectionId: string, questionId: string, responseType: ResponseType) => {
    // Clear logic rules when changing to an unsupported type
    const supportedLogicTypes = ["Text", "Number", "Checkbox", "Yes/No", "Multiple choice", "Slider"];
    ...
    updateQuestion(sectionId, questionId, {
      ...
      logicRules: supportedLogicTypes.includes(responseType) ?
        template.sections
    ...
    return (
      ...
      >
        ...
        <div className="question-footer">
          {["Text", "Number", "Checkbox", "Yes/No", "Multiple choice", "Slider"].includes(question.responseType) && (
            <EnhancedAddLogicButton
              hasRules={question.logicRules?.length ? true : false}
              onClick={() => {
                // Only show logic panel for supported types
                if (["Text", "Number", "Checkbox", "Yes/No", "Multiple choice", "Slider"].includes(question.responseType)) {
