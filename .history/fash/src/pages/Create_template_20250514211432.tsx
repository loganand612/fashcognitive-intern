...
const CreateTemplate: React.FC = () => {
  ...
  const renderTriggerUI = (question: Question, activeSection: Section) => {
    // Direct evidence upload component - always show for questions with require_evidence rule
    const hasEvidenceRule = question.logicRules?.some(r => r.trigger === "require_evidence" && !r.tempDisabled);
