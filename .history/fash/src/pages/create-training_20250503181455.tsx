...
const CreateTraining: React.FC = () => {
  ...
  useEffect(() => {
    const handleOutsideClick = (event: MouseEvent) => {
      if (showSlideLibrary && !slideLibraryRef.current?.contains(event.target as Node)) {
  ...
  const updateSlideContent = <T extends keyof Slide>(field: T, value: Slide[T]) => {
    const updatedLessons = [...lessons];
            ...
            <div className="train-form-group">
              ...
              <div className="train-media-upload">
                ...
                <button className="train-media-upload-button" onClick={() => handleImageUpload("image")}>
                  <ImageIcon size  onClick={() => handleImageUpload("image")}>
                  <ImageIcon size={16} />
                  <span>Upload Image</span>
                </button>
              </div>
