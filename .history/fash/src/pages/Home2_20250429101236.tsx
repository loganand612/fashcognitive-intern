...
import "./Home2.css"
import { Menu, ChevronDown, Share2, ArrowRight } from "lucide-react"
      ...
      <motion.section className="hero-section" ref={heroRef} style={{ opacity: heroOpacity, scale: heroScale }}>
        ...
        <div className="hero-content">
          ...
          <div className="feature-boxes">
            ...
            >
              <img
                src={createIcon || "/placeholder.svg"}
                alt="Create & Customize Inspections Icon"
            ...
            >
              <img
                src={conductIcon || "/placeholder.svg"}
                alt="Conduct Inspections & Collect Data Icon"
                className="feature-box-icon"
              />
            ...
            >
              <img
                src={analyzeIcon || "/placeholder.svg"}
                alt="Analyze & Take Action Icon"
                className="feature-box-icon"
              />
      ...
      <motion.section className="app-download-section" ref={appDownloadRef}>
        <div className="app-download-content">
          ...
          >
            ...
            >
              <img src={qr || "/placeholder.svg"} alt="QR Code" />
            </motion.div>
          </motion.div>
        </div>
      </motion.section>
