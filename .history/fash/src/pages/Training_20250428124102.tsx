...
type SlideItem = string | { title: string; description: string; image?: string }
...
export default function Training() {
  ...
  useEffect(() => {
    if (selectedSlide?.type === "horizontal-series") {
      const interval = setInterval(() => {
        setActiveSeriesIndex((prev) => (prev + 1) % (selectedSlide.items?.length || 1))
      }, 3000)
      ...
      case "horizontal-series":
        newSlide = {
          ...
          items: [
            ...
            {
              title: "Product Y",
              description: "Almost as good.",
            },
            {
              title: "Product Z",
              description: "The newest addition.",
            },
          ],
          doneText: "Continue",
