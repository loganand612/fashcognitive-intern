  ...
  return (
    <div className="training-container">
      ...
      <div className="editor-layout">
        ...
        <CenterPreview selectedLesson={selectedLesson} selectedSlide={selectedSlide} slidePosition={slidePosition} goToNextSlide={() => {}} sliderPosition={sliderPosition} setIsDragging={setIsDragging} comparisonContainerRef={comparisonContainerRef} sliderRef={sliderRef} activeSeriesIndex={activeSeriesIndex} setActiveSeriesIndex={setActiveSeriesIndex} />

        {/* Right sidebar - Editor */}
        <RightEditorPanel selectedSlide={selectedSlide} handleUpdateSlide={handleUpdateSlide} handleUpdateListItem={handleUpdateListItem} handleAddListItem={handleAddListItem} handleRemoveListItem={handleRemoveListItem} handleFileUpload={handleFileUpload} />
      </div>
      ...
      {slideLibraryOpen && (
        ...
        {/* Center column - Preview */}
        <CenterPreview selectedLesson={selectedLesson} selectedSlide={selectedSlide} slidePosition={slidePosition} goToNextSlide={goToNextSlide} sliderPosition={sliderPosition} setIsDragging={setIsDragging} comparisonContainerRef={comparisonContainerRef} sliderRef={sliderRef} activeSeriesIndex={activeSeriesIndex} setActiveSeriesIndex={setActiveSeriesIndex} />
