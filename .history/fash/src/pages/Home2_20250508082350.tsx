...
const Home2: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const templateImage = document.querySelector(".template-img-container") as HTMLElement
    const mobileImage = document.querySelector(".mobile-img-container") as HTMLElement
  ...
  useEffect(() => {
    if (workflowVisible) {
      const progressIndicators = document.querySelectorAll(".step-progress-indicator")
  ...
  return (
    <div className="Home2-fashcognitive-container">
      {/* Custom cursor */}
      ...
      <header className={`Home2-header ${isScrolled ? "Home2-scrolled" : ""}`}>
        <div className="Home2-header-content">
          <div className="Home2-logo">
            <span className="Home2-logo-text">FASHCOGNITIVE</span>
          </div>
          ...
          <nav className={`Home2-main-nav ${isMenuOpen ? "Home2-open" : ""}`}>
            <ul className="Home2-nav-list">
              <li className="nav-item">
                <a href="#features" className="nav-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
            ...
            <div className="nav-buttons">
              <a href="#login" className="btn btn-outline" onMouseEnter={enterButton} onMouseLeave={leaveHover}>
                Log In
              </a>
              <a href="#signup" className="btn btn-primary" onMouseEnter={enterButton} onMouseLeave={leaveHover}>
                Start Free
              </a>
            </div>
          </nav>
      ...
      <section className="hero-section" ref={heroRef}>
        <div className="container">
          <div className="hero-flex">
            ...
            <div className={`hero-image-container ${heroVisible ? "animate-in" : ""}`}>
              <div className="hero-image-slider">
                {bgImages.map((img, index) => (
                  <div key={index} className={`hero-slide ${currentBg === index ? "active" : ""}`}>
                    <Image
      ...
      <section className="workflow-section" ref={workflowRef}>
        <div className="container">
          <div className={`workflow-header animate-on-scroll ${workflowVisible ? "animate-in" : ""}`}>
          ...
          <div className="workflow-steps-container">
            {workflowSteps.map((step, index) => (
              <div
                key={index}
                className={`workflow-step-card animate-on-scroll`}
                style={{
              ...
              >
                ...
                <ul className="step-highlights">
                  {step.highlights.map((highlight, i) => (
                    <li
                      key={i}
                      className="highlight-item animate-on-scroll"
                ...
                <div className="step-progress-indicator" style={{ backgroundColor: step.color }} />
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="problems-section">
        <div className="container">
          ...
          <div className="problems-grid">
            {[0, 1, 2].map((index) => (
              <div key={index} className="problem-card animate-on-scroll" style={{ animationDelay: `${index * 0.2}s` }}>
          ...
          <div className="features-tabs">
            <div className="tabs-nav">
              {tabs.map((tab, index) => (
                <button
                  key={index}
                  className={`tab-button ${activeTab === index ? "active" : ""} animate-on-scroll`}
            ...
            <div className="tabs-content">
              <div className="tab-panel">
                <div className="tab-content animate-on-scroll">
                  ...
                  <a
                    href="#learn-more"
                    className="btn btn-outline btn-sm btn-hover-effect"
                    onMouseEnter={enterButton}
                    onMouseLeave={leaveHover}
                  >
                ...
                <div className="tab-image animate-on-scroll">
                  <Image
      ...
      <section className="template-feature" id="template-builder" ref={templateRef}>
        <div className="container">
          <div className="feature-content">
            <div className={`feature-text animate-on-scroll ${templateVisible ? "animate-in" : ""}`}>
              ...
              <ul className="feature-list">
                <li className="feature-item animate-on-scroll" style={{ animationDelay: "0.2s" }}>
                  <Check size={20} className="check-icon" />
                  <span>Dynamic conditional logic (if/then)</span>
                </li>
                <li className="feature-item animate-on-scroll" style={{ animationDelay: "0.3s" }}>
                  <Check size={20} className="check-icon" />
                  <span>Automated scoring and weighting</span>
                </li>
                <li className="feature-item animate-on-scroll" style={{ animationDelay: "0.4s" }}>
                  <Check size={20} className="check-icon" />
                  <span>Embed instructional text, images, or videos</span>
                </li>
                <li className="feature-item animate-on-scroll" style={{ animationDelay: "0.5s" }}>
                  <Check size={20} className="check-icon" />
            ...
            <div
              className={`feature-image template-img-container animate-on-scroll ${templateVisible ? "animate-in" : ""}`}
            >
              <Image
      ...
      <section className="mobile-feature" id="mobile-app" ref={mobileRef}>
        <div className="container">
          <div className="feature-content reverse">
            <div
              className={`feature-image mobile-img-container animate-on-scroll ${mobileVisible ? "animate-in" : ""}`}
            >
              <Image
            ...
            <div className={`feature-text animate-on-scroll ${mobileVisible ? "animate-in" : ""}`}>
        ...
        <div className="container">
          ...
          <div className="industries-grid">
            {industries.map((industry, index) => (
              <div
                key={index}
                className={`industry-card animate-on-scroll ${index >= 5 ? 'last-row-card' : ''}`}
                style={{
      ...
      <section className="testimonials-section" ref={testimonialsRef}>
        <div className="container">
          ...
          <div className="logos-row">
            {[1, 2, 3, 4, 5].map((logo) => (
              <div key={logo} className="logo-item animate-on-scroll" style={{ animationDelay: `${logo * 0.1}s` }}>
                <Image
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className={`faq-icon ${activeFaq === index ? "rotate" : ""}`}>
                    <ChevronDown size={20} />
                  </div>
                </button>
      ...
      <section className="cta-section" ref={ctaRef}>
        <div className="container">
          <div className={`cta-content animate-on-scroll ${ctaVisible ? "animate-in" : ""}`}>
            ...
            <div className="footer-columns">
              ...
              <div className="footer-column">
                ...
                <div className="social-links">
                  <a href="#twitter" className="social-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                    <svg
                  ...
                  <a href="#linkedin" className="social-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                  ...
                  <a href="#facebook" className="social-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                  ...
                  <a href="#instagram" className="social-link" onMouseEnter={enterLink} onMouseLeave={leaveHover}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
