  ...
  if (view === "dashboard") {
    return (
      ...
      <div className="training-top-nav">
        ...
        {createDialogOpen && (
          <div className="training-dialog-overlay" onClick={() => setCreateDialogOpen(false)}>
            <div className="training-dialog" onClick={(e) => e.stopPropagation()}>
              <div className="training-dialog-header">
                <h2>Course details</h2>
                <button className="training-close-button" onClick={() => setCreateDialogOpen(false)}>
                  <X />
                </button>
              </div>
              <div className="training-dialog-content">
                <div className="training-upload-area">
                  <div className="training-upload-icon">
                    <Upload />
                  </div>
                  <div className="training-upload-icon">
                    <ImageIcon />
              ...
              <div className="training-dialog-footer">
                <button className="training-cancel-button" onClick={() => setCreateDialogOpen(false)}>
                  Cancel
                </button>
                <button className="training-create-button" onClick={handleCreateCourse}>
                  Create
      </div>
    )
  }
