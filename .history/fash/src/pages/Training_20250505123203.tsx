...
const Training = () => {
  ...
  const handleFormSubmit = (event: React.FormEvent) => {
    ...
    // Navigate to create-training with course data
    navigate("/create-training", {
      state: {
        courseTitle: title,
        courseDescription: description,
        courseLogo: uploadedImage,
      },
    })
  }
      ...
      {isModalOpen && (
        <div className="box-modal-overlay">
          <div className="box-modal-content">
            <button className="box-modal-close" onClick={handleCloseModal}>
              ×
            </button>
            ...
            <div className="box-upload-section">
              {uploadedImage ? (
                <div className="uploaded-image-container">
                  <img src={uploadedImage || "/placeholder.svg"} alt="Uploaded logo" className="uploaded-image" />
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <input type="text" name="title" placeholder="Untitled course" required />
