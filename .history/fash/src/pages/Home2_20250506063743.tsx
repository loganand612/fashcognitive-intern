            ...
            >
              ...
              <div className="hero-buttons">
                <motion.a
                  ...
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(72, 149, 239, 0.5)" }}
                  whileTap={{ scale: 0.98 }}
                  onMouseEnter={enterButton}
                  onMouseLeave={leaveHover}
                >
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05, backgroundColor: "rgba(72, 149, 239, 0.1)" }}
                  whileTap={{ scale: 0.98 }}
                  onMouseEnter={enterButton}
                  onMouseLeave={leaveHover}
                >
          ...
          <div className="workflow-steps-container">
            {workflowSteps.map((step, index) => (
              <motion.div
                ...
                whileHover={{
                  y: -15,
                  boxShadow: "0 20px 40px rgba(72, 149, 239, 0.2)",
        ...
        <div className="container">
          ...
          <div className="problems-grid">
            <motion.div
              ...
              whileHover={{
                y: -15,
                boxShadow: "0 20px 40px rgba(72, 149, 239, 0.15)",
          ...
          <div className="industries-grid">
            {industries.map((industry, index) => (
              ...
              >
                ...
                <motion.div className="industry-arrow" initial={{ opacity: 0 }} whileHover={{ opacity: 1, x: 5 }}>
          ...
          <div className="faq-list">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                whileHover={{
                  boxShadow: activeFaq !== index ? "0 10px 30px rgba(72, 149, 239, 0.1)" : "",
                }}
              >
                <motion.button
