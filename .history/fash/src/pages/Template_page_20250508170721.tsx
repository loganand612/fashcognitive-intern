...
const TemplatePage: React.FC = () => {
  ...
  useEffect(() => {
    const animateOnScroll = () => {
      const elements = document.querySelectorAll('.tp-animate-on-scroll');
      ...
      elements.forEach((element) => {
        ...
        if (position.top < window.innerHeight * 0.9) {
          rect.classList.add('tp-animate-in');
        }
      });
    };
  ...
  return (
    <div className="tp-app-container">
      {/* Top Navigation */}
      <nav className={`tp-navbar ${isScrolled ? 'scrolled' : ''}`}>
      ...
      <div className="tp-template-container">
        ...
        <div className="tp-template-content">
          <section className="tp-creation-section tp-animate-on-scroll">
            ...
            <div className="tp-creation-options">
              <div className="tp-option-card tp-animate-on-scroll" style={{ animationDelay: '0.1s' }}>
              ...
              <div className="tp-option-card tp-animate-on-scroll" style={{ animationDelay: '0.2s' }}>
                <div className="tp-option-icon">
                  <FileText size={24} />
                </div>
              ...
              <div className="tp-option-card tp-animate-on-scroll" style={{ animationDelay: '0.3s' }}>
                <div className="tp-option-icon">
                  <Search size={24} />
                </div>
          ...
          <section className="tp-templates-section tp-animate-on-scroll" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="tp-create-dropdown" ref={dropdownRef}>
                ...
                {showCreateDropdown && (
                  <div className="tp-dropdown-menu">
                    <a href="/ct" className="tp-dropdown-item">
                      <FileText size={16} />
                      Standard Template
                    </a>
                    <a href="/gtemplate" className="tp-dropdown-item">
                      <FileText size={16} />
                      Garment Template
                    </a>
                  </div>
